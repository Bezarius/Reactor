...
namespace Assets.Reactor.Examples.PooledViews.Systems
{
    public class GroupReaction : IGroupReactionSystem
    {
        ...
        public void Reaction(IEntity entity)
        {
            ...
            var pos = viewComponent.View.transform.position;
            viewComponent.View.transform.position = new Vector3(pos.x + UnityEngine.Random.Range(-1, 1f), pos.y + UnityEngine.Random.Range(-1, 1f), pos.z + UnityEngine.Random.Range(-1, 1f));
        }
    }
}